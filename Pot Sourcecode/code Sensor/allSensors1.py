...
while i:
	...
	#Database
	sql = "INSERT INTO user_potInput(userID,light,waterTemp,temperature,diameter) VALUES (%s,%s,%s,%s,%s)"
	data = (userID,ch0,20.0,temperature,4.0) #hard code plantID, diameter, pumpSpeed
